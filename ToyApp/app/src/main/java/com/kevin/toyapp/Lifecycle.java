...
public class Lifecycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
                String previousContent = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY).toString();
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String displayContents = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, displayContents);
    }
