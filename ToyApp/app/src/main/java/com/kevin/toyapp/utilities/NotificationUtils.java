package com.kevin.toyapp.utilities;
...
import com.kevin.toyapp.HydrationReminder;
import com.kevin.toyapp.R;
...
public class NotificationUtils {
    ...
    private static PendingIntent contentIntent(Context context) {
        Intent startActivityIntent = new Intent(context, HydrationReminder.class);
