...
import com.kevin.toyapp.sync.ReminderTasks;
import com.kevin.toyapp.sync.ReminderUtilities;
import com.kevin.toyapp.sync.WaterReminderIntentService;
import com.kevin.toyapp.utilities.PreferenceUtilities;

public class HydrationReminder extends AppCompatActivity implements
        SharedPreferences.OnSharedPreferenceChangeListener {

    private static final String TAG = HydrationReminder.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hydaration_reminder);
