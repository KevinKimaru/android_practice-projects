    ...
    public void getAnswer(String AnswerString) {
        ...
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            if (qid < 20) {
                ...
                Intent intent2 = new Intent(QuestionActivity.this,

                        ResultActivity.class);

               Bundle  b2 = new Bundle();

                b2.putInt("score", score); // Your score

                intent.putExtras(b2); // Put your score to your next
